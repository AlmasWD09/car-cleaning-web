  ...
  const photoLibraryData = [
    {
      id: 1,
      category: "Categoty 1",
      image: "/gallaryPhoto/photo1.JPEG",
    },
    {
      id: 2,
      category: "Categoty 2",
      image: "/gallaryPhoto/photo2.JPG",
    },
    {
      id: 3,
      category: "Categoty 3",
      image: "/gallaryPhoto/photo3.jpg",
    },
    {
      id: 4,
      category: "Categoty 4",
      image: "/gallaryPhoto/photo4.jpeg",
    },
    {
      id: 5,
      category: "Categoty 5",
      image: "/gallaryPhoto/photo5.JPG",
    },
    {
      id: 6,
      category: "Categoty 6",
      image: "/gallaryPhoto/photo6.jpeg",
    },
    {
      id: 7,
      category: "Categoty 7",
      image: "/gallaryPhoto/photo7.jpeg",
    },
    {
      id: 8,
      category: "Categoty 8",
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-5">
        {photoLibraryData.map((item, index) => {
          return (
            <div key={index}>
              <div className="relative">
                <img src={item.image} alt="photo" className="w-full h-[240px] rounded-lg object-cover" />

                <span
                  onClick={() => hendelClick(item.id)}
                  className="absolute top-0 right-0 p-1 rounded-full cursor-pointer" tyle={{ backgroundColor: 'rgba(31, 41, 55, 0.6)' }}>
                ...
                {imageMadel && imageID == item.id && (
                  <div className="bg-white  absolute bottom-[100px] right-4 cursor-pointer shadow-lg">
                    ...
                    <Button
                      ...
                      className="flex  justify-start items-center  w-full  border-none px-3 py-1">
